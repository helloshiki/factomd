...
func init() {
	//pub, err := factom.GetECAddress("EC2NG6CMgf2EprnEvFobSnxkrSfSco1YJ6YhD9WGMRCSRe4ngXnF")
	//if err != nil {
	//	panic(err)
	//}
	priv, err := factom.GetECAddress("Es2sDKExgLLVSozfLHxRnT37su3iCzqK2fsmGTxXf3FN2ZktUj1G")
	if err != nil {
		panic(err)
	}
	fmt.Printf("XXXXXXXXX %+v\n", priv)
	anchorCfg.Anchor.ServerECPrivKey = "3a06ae4267ac092499cbbe8a7a1c9e11a89ac94d6a649ffe801ca322277d53da"
	anchorCfg.Anchor.ServerECPublicKey = "f6a6242dcae1d4e4165b91f56dba7cb99576509ba1f587ec74b2a9933dd128b7"
	anchorCfg.Anchor.ServerPrivKey = "ec9f1cefa00406b80d46135a53504f1f4182d4c0f3fed6cca9281bc020eff973"
	anchorCfg.Anchor.AnchorChainID = "df3ade9eec4b08d5379cc64270c30ea7315d8a8a1a69efe2b98a60ecdd69e604"// "df3ade9eec4b08d5379cc64270c30ea7315d8a8a1a69efe2b98a60ecdd69e604"
	...
	anchorCfg.Btc.BtcTransFee                           = 0.00001
